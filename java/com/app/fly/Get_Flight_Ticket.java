                    ...
                    bookingRef.get()
                            .addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                                ...
                                public void onSuccess(DocumentSnapshot documentSnapshot) {
                                    ...
                                    Intent intent = new Intent(Get_Flight_Ticket.this,Menu.class);
                                    intent.putExtra("passenger",passenger);
                                    intent.putExtra("status",documentSnapshot.getString("status"));
                                    startActivity(intent);
                                    Toast.makeText(Get_Flight_Ticket.this,"It is just for displaying message ",Toast.LENGTH_LONG).show();
                                }
                            });
                }
                catch(Exception e)
